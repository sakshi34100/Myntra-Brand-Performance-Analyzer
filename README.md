...
2. Active Brand Filter
Applied a threshold of Minimum 5 Products to eliminate "noise" from inactive or trial sellers.

📉 Key Insights & Challenges
Data Noise Management: Successfully filtered out products with Rating = 0 to ensure the Average Rating (4.16) reflected genuine customer feedback rather than new product bias.

Volume Bias: Identified that while top-selling brands have the highest absolute count of unsatisfied products, their Unsatisfied % often remains within acceptable limits compared to niche high-risk brands.

Risk Correlation: Discovered a trend where specific "Mid-Range" price segments exhibited higher dissatisfaction rates compared to "Budget" and "Premium" categories.
